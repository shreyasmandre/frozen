...
\end{align}
The determination of amplification according to \eqref{eqn:amp2} is found according to a multiply nested algorithm shown schematically in figure \ref{fig:Algorithm}. 
Each rectangle represents a subroutine for performing the function listed inside it, and is passed as a black box to the  nesting rectangle.
