...
GNUTERM = "qt"
set term push;
set term postscript eps enhanced color solid size 12cm,10cm font 12
set output 'beta.eps'
plot '<cat data/C_omega0_*.mat' u 1:2:3 notitle w l lc palette z, 'data/C_omega0_2.000.mat' u 1:2:3 notitle w l lt -1 lw 2
set output;
set term pop;
#    EOF
